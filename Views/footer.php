                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-12 col-sm-6">
                                        ...
                                        <div class="widget">
                                            <h3 class="widget-title">ABOUT SHOP</h3>
                            ...
                            <div class="col-md-2 col-sm-6">
                                ...
                                <div class="widget">
                                    ...
                                    <ul>
                                        <li><a href="/cart/" title="">Your Cart</a>
                                        </li>
                                        <li><a href="#" title="">Your Orders</a>
                                        </li>
                                        <li><a href="#" title="">Wishlist Items</a>
                                        </li>
                                        <li><a href="#" title="">Exchange Rates</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /.widget -->
...
<!-- END FOOTER -->
    ...
    <script src="/assets/js/from_template/plugins.js"></script>

    <script src="/assets/js/from_template/main.js"></script>

    <script src="/assets/js/from_template/docs.js"></script>
