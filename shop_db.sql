...
--
-- Host: 127.0.0.1
-- Czas generowania: 04 Maj 2017, 23:23
...
INSERT INTO `products` (`productCode`, `productName`, `productDescription`, `quantityInStock`, `buyPrice`, `warehouseCode`, `main_img`) VALUES
(1, 'BBS 1', 'Lorem', 20, '810.00', '1', 'assets/img/products/image-wheels-bps-15-500x500.jpg'),
(2, 'OZ.1', 'Cool wheels...', 125, '600.00', '1', 'assets/img/products/image-wheels-brm-17-500x500.jpg'),
(3, 'Worki', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum ducimus et laborum, magnam? Aliquam quo ad delectus, quos ex corporis suscipit tempore minima error, provident magnam id hic odit. Iure!', 45, '750.00', '1', 'assets/img/products/image-wheels-bl-18-500x500.jpg');
...
--
ALTER TABLE `products`
  MODIFY `productCode` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
